...
class MavlinkInterface {
  public:
    ...
    bool GetArmedState ();
    void onSigInt ();
    inline bool GetReceivedFirstActuator ()
    {
    ...
    inline void SetSerialEnabled (bool serial_enabled)
    {
        serial_enabled_ = serial_enabled;
    }
    inline void SetUseTcp (bool use_tcp)
    {
        use_tcp_ = use_tcp;
    }
    ...
    inline void SetEnableLockstep (bool enable_lockstep)
    {
        enable_lockstep_ = enable_lockstep;
    }
    inline void SetMavlinkAddr (std::string mavlink_addr)
    {
        mavlink_addr_str_ = mavlink_addr;
    }
    inline void SetMavlinkTcpPort (int mavlink_tcp_port)
    {
        mavlink_tcp_port_ = mavlink_tcp_port;
    }
    inline void SetMavlinkUdpPort (int mavlink_udp_port)
    {
        mavlink_udp_port_ = mavlink_udp_port;
    }
    inline void SetGcsAddr (std::string gcs_addr)
    {
        gcs_addr_ = gcs_addr;
    }
    inline void SetGcsUdpPort (int gcs_udp_port)
    {
        gcs_udp_port_ = gcs_udp_port;
    }
    inline void SetSdkAddr (std::string sdk_addr)
    {
        sdk_addr_ = sdk_addr;
    }
    inline void SetSdkUdpPort (int sdk_udp_port)
    {
        sdk_udp_port_ = sdk_udp_port;
    }
    inline void SetHILMode (bool hil_mode)
    {
        hil_mode_ = hil_mode;
    }
    inline void SetHILStateLevel (bool hil_state_level)
    {
  ...
  private:
    ...
    // Serial interface
    void do_read ();
    void parse_buffer (const boost::system::error_code &err,
                       std::size_t bytes_t);
    inline bool is_open ()
    {
